...
namespace Calabonga.Facts.Web.Infrastructure.Services
{
    public interface ITagService
    {
        ...
        /// <returns></returns>
        Task ProcessTagsAsync(FactEditViewModel viewModel, Fact fact, CancellationToken cancellationToken);
    }
    ...
    public class TagService : ITagService
    {
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        public async Task ProcessTagsAsync(FactEditViewModel viewModel, Fact fact, CancellationToken cancellationToken)
        {
            ...
            if (fact.Tags != null && !fact.Tags.Any())
            {
